...
More cool stuff:
Our program supports sin, cos, tan, modulo as well as exponentiation
Our program also checks for all invalid expressions and prints "INVALID EXPRESSION!" or "ERROR CAUGHT!"whenever we have an invalid expression. This is really useful if the entered value is not valid.
...
NB: URLinkedList, MyLinkedList, and others, are just files that help in the implementation of the data structures we need. The data structures were created for this project from scratch.
